Scaling [cybersecurity-rtms-main-3f10] With Kubernetes
===========================

Generated On: 2026-06-15 00:14:57 UTC
...
Based on your TML solution [cybersecurity-rtms-main-3f10] - if you want to scale your application with Kubernetes - you will need to apply the following YAML files.

.. list-table::

   * - **YML File**
     - **Description**
   * - :ref:`cybersecurity-rtms-main-3f10.yml`
   ...
   * - :ref:`qdrant.yml`
     - This is the Qdrant deployment YAML.
       ...
       applied if using Step 9 DAG.
   * - :ref:`nginx-ingress-cybersecurity-rtms-main-3f10.yml`
     - If you are scaling your TML solution you must

       apply the nginx-ingresscybersecurity-rtms-main-3f10.yml; this yaml is 
...
.. code-block:: YAML
   ...
   kubectl apply -f kafka.yml -f secrets.yml -f mysql-storage.yml -f mysql-db-deployment.yml -f cybersecurity-rtms-main-3f10.yml

cybersecurity-rtms-main-3f10.yml
------------------------

.. important::
   Copy and Paste this YAML file: cybersecurity-rtms-main-3f10.yml - and save it locally.

   These YML files can also be found on GitHub at: https://github.com/smaurice101/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/cybersecurity-rtms-main-3f10/ymls/cybersecurity-rtms-main-3f10
...
.. code-block:: YAML
   ...
   ################# cybersecurity-rtms-main-3f10.yml
     ...
     kind: Deployment
     metadata:
       name: cybersecurity-rtms-main-3f10
     spec:
       selector:
         matchLabels:
           app: cybersecurity-rtms-main-3f10
       ...
       template:
         ...
         spec:
           containers:
           - name: cybersecurity-rtms-main-3f10
             image: maadsdocker/cybersecurity-rtms-main-3f10-amd64:latest
             volumeMounts:
             - name: dockerpath
   ...
   ---
     ...
     kind: Service
     metadata:
       name: cybersecurity-rtms-main-3f10-visualization-service
       labels:
         app: cybersecurity-rtms-main-3f10-visualization-service
     spec:
       type: ClusterIP
       ports:
...
.. code-block::
   ...
   kubectl port-forward deployment/cybersecurity-rtms-main-3f10 6060:6060

After you forward the ports then copy/paste the viusalization URL below and run your dashboard.

.. code-block::

   http://localhost:6060/rtmscyber.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   ...
   **STEP 4:  Apply nginx-ingress-cybersecurity-rtms-main-3f10.yml to your kubernetes cluster.  First you need to save it locally then apply it:**

nginx-ingress-cybersecurity-rtms-main-3f10.yml
-------------
   ...
   .. code-block::
      ...
      kubectl apply -f nginx-ingress-cybersecurity-rtms-main-3f10.yml
...
.. code-block::
   ...
   http://tml.tss/viz/rtmscyber.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
